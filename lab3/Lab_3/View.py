...
class View(Tk):
    def __init__(self):
        ...
        self.__bd_lbl = Label(self.__frame, text="BTree", font=("Times New Roman", 14))
        self.__key_lbl = Label(self.__frame, text="Key", font=("Times New Roman", 12))
        self.__key_ent = Entry(self.__frame, font=("Times New Roman", 12))
        self.__value_lbl = Label(self.__frame, text="Value", font=("Times New Roman", 12))
        self.__value_ent = Entry(self.__frame, font=("Times New Roman", 12))
        self.__clear_btn = Button(self.__frame, text="Clear fields", font=("Times New Roman", 12), command=self.__clear)
        self.__choose_lbl = Label(self.__frame, text="Choose option", font=("Times New Roman", 14))
        self.__action = IntVar()
        self.__action.set(1)
        self.__search_rbtn = Radiobutton(self.__frame, text="Search by key", variable=self.__action, value=1,
                                         font=("Times New Roman", 12))
        self.__add_rbtn = Radiobutton(self.__frame, text="Add value", variable=self.__action, value=2,
                                      font=("Times New Roman", 12))
        self.__delete_rbtn = Radiobutton(self.__frame, text="Delete value", variable=self.__action, value=3,
                                         font=("Times New Roman", 12))
        self.__edit_rbtn = Radiobutton(self.__frame, text="Change", variable=self.__action, value=4,
                                       font=("Times New Roman", 12))
        self.__submit_btn = Button(self.__frame, text="Execute", font=("Times New Roman", 12), command=self.__submit)
        self.__result = StringVar()
        self._control = Control(self)
        self.__result_lbl = Label(self.__frame, textvariable=self.__result, font=("Times New Roman", 14))
        self.__save_btn = Button(self.__frame, text="Save results to file", font=("Times New Roman", 12),
